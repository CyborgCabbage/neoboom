...
import net.cyborgcabbage.neoboom.level.ExtinguishingExplosion;
...
public class ExtinguishingBomb extends BombType {
    @Override
    ...
    public void explode(PrimedBomb entity) {
        ExtinguishingExplosion explosion = new ExtinguishingExplosion(entity.level, null, entity.x, entity.y, entity.z, ((BombPower)BlockBase.BY_ID[entity.blockId]).power);
    ...
    public int getTextureForSide(String prefix) {
        ...
        return TextureListener.getBlockTexture(prefix + "_extinguishing_bomb_side");
    }
